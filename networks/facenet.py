'''
Edited and adapted from https://github.com/j-alex-hanson/rethinking-race-face-datasets/blob/main/models/resnet.py
'''
...
model_dict = {
    'resnet_face18': [resnet_face18, 512],
    'resnet_face50': [resnet_face50, 2048],
}

class SupConResNet(nn.Module):
    """backbone + projection head"""
    def __init__(self, name='resnet_face50', head='mlp', feat_dim=128):
...
class SupCEResNet(nn.Module):
    """encoder + classifier"""
    def __init__(self, name='resnet_face50', num_classes=10):
